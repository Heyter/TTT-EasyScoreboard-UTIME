...
EZS.CreateUTimeLabel = { enabled = true, text = "Hours" }
...
function EZS.AddRankLabel( sb )
	...
	local utimelabel = EZS.CreateUTimeLabel.enabled and EZS.CreateUTimeLabel.text or ""
	...
	sb:AddColumn(utimelabel, function(client, label) 
		return math.floor(client:GetUTimeTotalTime() / 3600)
	end)
